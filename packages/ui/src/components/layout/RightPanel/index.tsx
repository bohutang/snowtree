              ...
              <div className="space-y-1.5">
                ...
                {onPushPR && (
                  <button
                    type="button"
                    onClick={onPushPR}
                    disabled={isPushPRDisabled || isDisabled || remotePullRequest?.merged || !hasSessionCommits || (remotePullRequest && prSyncStatus?.localAhead === 0)}
                    ...
                    style={{
                      backgroundColor: colors.bg.hover,
                      border: `1px solid ${colors.border}`,
                      color: (isPushPRDisabled || isDisabled || remotePullRequest?.merged || !hasSessionCommits || (remotePullRequest && prSyncStatus?.localAhead === 0))
                        ? colors.text.muted
                        : colors.accent,
                    }}
